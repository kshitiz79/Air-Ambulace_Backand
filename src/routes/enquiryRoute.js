...
// CMHO-specific route for dashboard stats
router.get('/cmho/dashboard-stats', ctl.getCMHODashboardStats);

// Regular routes (now with user filtering for CMHO)
...
router.patch('/:id/forward', ctl.forwardEnquiryToCollector); // New route
